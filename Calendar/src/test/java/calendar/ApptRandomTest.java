			...
			for (int i = 0; i < NUM_TESTS; i++) {
					String methodName = ApptRandomTest.RandomSelectMethod(random);
					   ...
					   /****************************************************************/
						   ...
						   int newHour=ValuesGenerator.getRandomIntBetween(random,-160,100);
						   appt.setStartHour(newHour);
					   }
					   else if (methodName.equals("setStartMinute")){
						   int newMin=ValuesGenerator.getRandomIntBetween(random,-120,110);
						   appt.setStartMinute(newMin);
					   }
					   else if (methodName.equals("setStartDay")){
						   int newDay=ValuesGenerator.getRandomIntBetween(random,-150,100);
						   appt.setStartDay(newDay);
					   }
					   else if (methodName.equals("setStartMonth")){
						   int newMonth=ValuesGenerator.getRandomIntBetween(random,1,25);
